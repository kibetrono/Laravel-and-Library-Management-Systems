...
// Set default panel
if ($panel == '' && in_array($widget->position, array('slideshow', 'top-a', 'top-b', 'top-c', 'top-d', 'bottom-a', 'bottom-b', 'bottom-c', 'bottom-d', 'bottom-e', 'bottom-footer', 'main-top', 'main-bottom', 'sidebar-a', 'sidebar-b'))) {
    $panel = $this['config']->get("panel_default.{$widget->position}.panel", '');
}
// Set panel for specific positions
else if (in_array($widget->position, array('headerbar','toolbar-l','toolbar-r', 'footer-r', 'footer-l', 'offcanvas'))) {
    $panel = 'uk-panel';
}
// Set badge
...
// Set title
if (in_array($widget->position, array('headerbar','toolbar-l','toolbar-r', 'footer-r', 'footer-l'))) {
    $title = '';
...
if ($widget->menu) {
    ...
    } else if (in_array($widget->position, array('toolbar-l','toolbar-r', 'footer-r', 'footer-l'))) {
        $renderer = 'subnav';
...
// Render widget
if (in_array($widget->position, array('breadcrumbs', 'logo', 'logo-small', 'search', 'dotnav', 'debug')) || (($widget->position == 'offcanvas') && $widget->menu)) {
    echo $content;
