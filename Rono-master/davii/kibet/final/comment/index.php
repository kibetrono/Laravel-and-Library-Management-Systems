...
function validation()
{
	...
	var jo=document.comment.client.value;
	var jo1=document.getElementById('tjobid');
	if(jo=="")
	{
		document.comment.client.focus();
...
<table width="500" border="0" cellspacing="3" cellpadding="3" style="margin:auto;">
  ...
  <tr>
    <td align="right" id="one">Client(farmers,researchers,student..etc) :<span style="color:#F00;">*</span></td>
    <td><input type="text" name="client" id="tjobid"></td>
  </tr>
  <tr>
