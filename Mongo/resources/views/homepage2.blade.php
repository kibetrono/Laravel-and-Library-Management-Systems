...
/* Content */
#content {float:left; width:83%; margin:0; padding:0 0 0 20px;}
...
/* Footer */
#footer {position:relative; clear:both; width:100%; height:60px; margin-bottom:50px; background:url("../design/footer.jpg") 0 0 no-repeat; color:#6685CC;}
...
<ul class="box">
    ...
    <li><a href="{{url('main')}}"><i class="fas fa-newspaper"></i>News<span class="tab-l"></span><span class="tab-r"></span></a></li>
     <li><a href="{{url('library')}}"><i class="fas fa-book-reader"></i>Library<span class="tab-l"></span><span class="tab-r"></span></a></li>
      ...
      <li><a href="{{url('')}}">About<span class="tab-l"></span><span class="tab-r"></span></a></li>
...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                  <h2>About the WebGuide System</h2>
            ...
            <p>Web Guide system offers an effective interface to its users to effectively and quicky get their query responses in a simple and cheaper way</p>
            </div>
